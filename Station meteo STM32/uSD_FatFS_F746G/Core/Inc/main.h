...
#define rge_Pin GPIO_PIN_9
#define rge_GPIO_Port GPIOH
#define vrt_Pin GPIO_PIN_11
#define vrt_GPIO_Port GPIOH
#define ble_Pin GPIO_PIN_10
#define ble_GPIO_Port GPIOH
